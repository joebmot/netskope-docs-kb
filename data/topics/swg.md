...
**Scraped:** 2026-08-05T08:31:06.326342+00:00
...
**Last Modified:** 2025-08-31T01:51:20+00:00
**Scraped:** 2026-08-05T08:31:29.223627+00:00
...
**Scraped:** 2026-08-05T08:31:57.617757+00:00
...
**Scraped:** 2026-08-05T08:33:19.104398+00:00
...
**Scraped:** 2026-08-05T08:34:45.765370+00:00
...
**Scraped:** 2026-08-05T08:34:46.893740+00:00
...
**Scraped:** 2026-08-05T08:34:49.142293+00:00
...
**Scraped:** 2026-08-05T08:35:20.027181+00:00
...
**Scraped:** 2026-08-05T08:39:50.061511+00:00
...
**Scraped:** 2026-08-05T08:41:29.487032+00:00
...
In this Topic
Supported AWS Entities for Real-time Protection
Supported AWS Entities for Real-time Protection - Netskope Technical Documentation
...
**Scraped:** 2026-08-05T08:44:53.033714+00:00
...
**Scraped:** 2026-08-05T08:45:10.084769+00:00
...
**Last Modified:** 2025-08-31T01:50:21+00:00
**Scraped:** 2026-08-05T08:54:21.617114+00:00
...
**Last Modified:** 2026-07-08T08:53:45+00:00
**Scraped:** 2026-08-05T08:55:19.345660+00:00
...
https://xyz.com
) or a URL with variables from the Insert Variable menu (e.g.,
https://xyz.com/{{x-cs-uri-path}}/{{cs-uri-query}}
). URLs entered with a scheme (
http://
or
https://
) are treated as absolute URLs and redirect externally to that destination. URLs entered without a scheme (e.g.,
xyz.com
or
/some/path
) are treated as relative paths and are appended to the source (current) host instead of redirecting externally. To ensure an external redirect, always include the scheme in the URL. A maximum of 1,024 characters, including variables, is supported before variable substitution. After substitution, the URL is truncated at 8,192 characters.
User Alert
...
Note
: This quarantine folder is configurable on Box, Dropbox, Egnyte, Google Drive, Microsoft 365 OneDrive & SharePoint running on Classic API Data Protection. This is not available on SaaS apps running on the
Next Generation API Data Protection
platform. It is important to note that Classic API Data Protection will reach end-of-life on June 1, 2027. To learn more, see
...
**Last Modified:** 2025-08-31T01:50:20+00:00
**Scraped:** 2026-08-05T08:55:21.614167+00:00
...
**Last Modified:** 2026-08-03T15:06:29+00:00
**Scraped:** 2026-08-05T09:10:53.885476+00:00
...
Contact your Netskope account team to enable Agentic Broker in your account. Additional licensing is required for Agentic Broker and DLP.
NOTE
: To create a DLP policy, the DLP add-on license is required if you do not have DLP enabled in your account.
...
To create policies based on fields in HTTP headers such as
mcp-session-id
and
mcp-protocol-version
. See
...
MCP traffic is controlled through a dedicated Agentic Access policy type, confirmed at
Policies
>
Real-time Protection
>
...
>
Agentic Access
. This replaces the previous approach of selecting an MCP server or the MCP Server category from the general Cloud Access Application or Category dropdown — MCP servers and the MCP Server category no longer appear there.
Destination
The Destination field offers three options (Category, Remote MCP Server, Any MCP Server Traffic)
Remote MCP Server
— Applies to specific MCP server(s) selected. Select one or more individual MCP servers from a searchable list.
Category
— Applies to remote MCP servers in the MCP Servers Catalog.
Any MCP Server Traffic
— Applies to all remote MCP servers.
Regardless of the selected Destination, the following fields are available:
MCP Protocol Version
— A dynamically updated list with protocol version available specific to the selected MCP server.
Activities
— A list of supported activities for the selected MCP server.
Add Criteria & Constraints
— This option is available when you select “Any MCP Server Traffic” as the destination
* The Threat Protection Profile is currently not supported for securing MCP communications in Agentic Broker.
...
**Scraped:** 2026-08-05T09:12:12.375133+00:00
...
---
## Create an Agent Guardrails Policy for Real-time Protection
**URL:** https://docs.netskope.com/en/create-an-agent-guardrails-policy-for-real-time-protection/
**Last Modified:** 2026-07-09T23:40:10+00:00
**Scraped:** 2026-08-05T09:15:07.337012+00:00

Create an Agent Guardrails Policy for Real-time Protection - Netskope Knowledge Portal
Create an Agent Guardrails Policy for Real-time Protection
...
Source
: Search for and select the Agents to use. Click
Add Criteria
to add other sources, like users, user groups, organizational units, source IP, and Source IP (egress) that you want to group with the agents to restrict the scope.
Destination
: Select the traffic destination you want to apply the Agent Guardrails policy to. Select
Applications
from the dropdown, and then add the Cloud Apps to manage with this policy.
Profile & Action
: Configure the following.
Agent Guardrails
: Select the Agent Guardrails profiles you want to add to the Real-time Protection policy. You can add multiple profiles to a Real-time Protection policy.
Profile Action
: Select the action you want Netskope to take when users trigger the policy.
Alert
Allow
...
If you select
Block
, you can also choose a default or custom notification template to send to the end-user for user coaching if Netskope detects a policy violation.
Policy Name
: Enter a policy name. You can only use alphanumeric characters and symbols such as underscore (_), dash (-), and square brackets ([ ]). You cannot use the greater-than (>) or less-than (<) symbols in policy names.
+ Policy Description
: Click to add notes or information.
+ Email Notification
: Netskope doesn’t send email-based notifications for Agent Guardrails alerts.
Status
: Ensure it’s
Enabled
so the policy is active.
Click
Save
. The new policy appears on the Real-time Protection Policy page.
In the
Move Policy
window, move the Agent Guardrails policy based on your interpretation of the severity of the content moderation.
Click
Save
.
Click
...
**Scraped:** 2026-08-05T09:15:53.488676+00:00
...
**Scraped:** 2026-08-05T09:15:56.894987+00:00
